...
include_once "envioMailCompra.php";

//$mailLaboral = $_POST["mailLaboral"]; 


$Tarjeta = $_POST["TipoTarjeta"];
$CantMonedas = $_POST["Cantidad"];
...
try {
   ...
   // $mail->addAddress($mailLaboral);     //Casilla Destino a la que se enviará el email
    $mail->addAddress('faaatorres@hotmail.com');     //Casilla Destino a la que se enviará el email
    ...
    $mail->isHTML(true);                                  
	$mail->CharSet = 'UTF-8';
    $mail->Subject = "SwapArea Compra de moneda"; 
    $mail->Body    = "Estimado usuario, recibimos su solicitud para comprar monedas, la misma fue aprobada usted compro  <b>$CantMonedas</b> monedas, con su tarjeta <b>$Tarjeta</b>";
