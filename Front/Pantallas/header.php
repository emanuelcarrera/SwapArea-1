					...
					<div class="collapse navbar-collapse" id="navbarCollapse">
						...
						<li class="nav-item active">
							...
							<li class="nav-item active" id="misarticulos">
								<a class="nav-link" href="../Articulos/misArticulos.php"><i class="fa fa-cube" aria-hidden="true"></i>Mis Articulos</a>
							</li>
						 ...
						 <a id="perfil"  href="../Usuarios/perfilUsuario.php" > <img id="Headerimg" src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" width="50" height="50" class="rounded-circle"  >
