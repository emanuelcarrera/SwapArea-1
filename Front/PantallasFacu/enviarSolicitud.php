...
include_once "envioMailIntercambio.php";
...
try {
    ...
    $mail->isHTML(true);                                  
	$mail->CharSet = 'UTF-8';
    $mail->Subject = "SwapArea solicitud intercambio"; 
    $mail->Body    = "Estimado usuario, acaba de recibir una nueva solicitud de intercambio";
