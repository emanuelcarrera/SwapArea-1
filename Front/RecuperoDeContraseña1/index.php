...
if (!$email) {
	...
	$sel_query = "SELECT * FROM `usuarios` WHERE Mail='".$email."'";
...
$mail->SMTPAuth = true;
$mail->Username = "swaparea21@gmail.com"; // Enter your email here
$mail->Password = "FacuEma2021"; //Enter your passwrod here
$mail->Port = 25;
$mail->IsHTML(true);
