...
class Solicitudes {
    ...
    public function getSolitudesByUser($idusuario)
    {
      ...
      $consulta = $objAccesoDatos->prepararConsulta("SELECT       
       ...
       (SELECT urlFoto from fotosariculos where idArticulo = art1.idArticulo LIMIT 1 ) AS FOTO_ART_,
       ART1.Valor AS VALOR_ART,
       art2.idArticulo AS ID_ART_OFERTA, 
       ART2.Nombre AS NOMBRE_ART_OFERTA,
       (SELECT urlFoto from fotosariculos where idArticulo = art2.idArticulo LIMIT 1 ) AS FOTO_ART_OFERTA,
